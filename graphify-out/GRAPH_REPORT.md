...
Cohesion: 0.13
Nodes (15): cmdk, jszip, next, dependencies, cmdk, jszip, next, @radix-ui/react-avatar (+7 more)
...
Cohesion: 0.18
Nodes (11): drizzle-kit, eslint, devDependencies, drizzle-kit, eslint, @tailwindcss/postcss, @types/pg, typescript (+3 more)
...
## Knowledge Gaps
- **363 isolated node(s):** `DashboardShellProps`, `User`, `Props`, `SidebarContextProps`, `BuilderState` (+358 more)
...
- **Why does `hasPermission()` connect `hasPermission` to `schema.ts`, `auth.ts`, `responsibility-templates/route.ts`, `portfolio/route.ts`, `publish/route.ts`, `workspace-manifest.ts`, `[userId]/route.ts`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **What connects `DashboardShellProps`, `User`, `Props` to the rest of the system?**
