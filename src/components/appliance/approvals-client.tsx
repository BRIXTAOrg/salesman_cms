  ...
  return (
    <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-6 p-4 md:p-6">
      <PageIntro
        eyebrow="Workspace"
        title="Approvals"
        description="One decision inbox for approvals and reviews generated by published Responsibilities. BRIXTA only shows decisions the current user is authorized to make."
        action={
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="When a Responsibility requires approval or review, the authorized person will see it here."
        />
      ) : (
